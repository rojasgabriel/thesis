...
class PsychometricTests(unittest.TestCase):
    def test_package_adapter_uses_labdata_rightward_response_code(self):
        fake_module: Any = types.ModuleType("fit_psychometric")
        ...
        from thesis.behavior.psychometrics import fit_psychometric_labdata
...
class LearningTests(unittest.TestCase):
    def test_summarize_trialset_counts_choice_and_means(self):
        from thesis.behavior.learning import summarize_trialset
...
class KernelTests(unittest.TestCase):
    def test_kernel_keeps_unobserved_late_bins_as_nan(self):
        from thesis.behavior.kernels import build_residual_rate_matrix
    ...
    def test_kernel_fit_is_deterministic(self):
        from thesis.behavior.kernels import fit_psychophysical_kernel
